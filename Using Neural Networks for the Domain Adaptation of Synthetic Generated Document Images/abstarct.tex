...
\begin{abstract}
\begin{comment}
I would like to express my gratitude to my advisors, Tobias Scheck, Paul Fischer, Thaddäus Strobel, Dr. Martin Voigt, and Clemens Reinhardt, who helped me throughout this project. Special thanks to Dr. Martin Voigt for allowing many students like me into elevait GmbH \& Co. KG to pursue research using state-of-the-art infrastructure. Also, I would like to extend a special thanks to my parents and my friends for their enormous support.
\end{comment}
\end{abstract}}
